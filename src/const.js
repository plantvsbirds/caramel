...
export const CaramelLogo = ({ className }) => (
    <span
        ...
        className={className}
    >
    <svg width="200px" viewBox="0 0 658 590">
        <desc>Created with Sketch.</desc>
        <defs>
